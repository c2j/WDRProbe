...
const translations = {
  en: {
    ...
    'vis.import': 'Import',
    'vis.import.title': 'Import Execution Plan',
    'vis.import.file': 'Plan File',
    'vis.import.noFile': 'No file selected',
    'vis.import.browse': 'Browse...',
    'vis.import.fileHint': 'Supports JSON and TEXT format execution plans (EXPLAIN ANALYZE output)',
    'vis.import.format': 'Format',
    'vis.import.textFormat': 'Text Format',
    'vis.import.planText': 'Plan Text',
    'vis.import.textPlaceholder': 'Paste your execution plan JSON or TEXT here...',
    'vis.import.planRequired': 'Plan text is required',
    'vis.import.readError': 'Failed to read file',
    'vis.import.openFailed': 'Failed to open file dialog',
    'vis.import.importFailed': 'Failed to import plan',
    'vis.import.importBtn': 'Import Plan',
    'vis.import.importing': 'Importing...',
    'vis.import.sqlPlanHint': 'Import SQL statements with their EXPLAIN output. Format: "gaussdb=# explain select...; PLAN ..."',
    'vis.import.sqlPlanPlaceholder': 'Paste SQL statements and their execution plans here. Each SQL should be followed by its EXPLAIN output...',
    'vis.view': 'View',
  ...
  zh: {
    ...
    'vis.title': '执行计划可视化',
    'vis.import': '导入',
    'vis.import.title': '导入执行计划',
    'vis.import.file': '计划文件',
    'vis.import.noFile': '未选择文件',
    'vis.import.browse': '浏览...',
    'vis.import.fileHint': '支持 JSON 和 TEXT 格式的执行计划（EXPLAIN ANALYZE 输出）',
    'vis.import.format': '格式',
    'vis.import.textFormat': '文本格式',
    'vis.import.planText': '计划文本',
    'vis.import.textPlaceholder': '在此粘贴您的执行计划 JSON 或 TEXT...',
    'vis.import.planRequired': '计划文本是必需的',
    'vis.import.readError': '读取文件失败',
    'vis.import.openFailed': '打开文件对话框失败',
    'vis.import.importFailed': '导入计划失败',
    'vis.import.importBtn': '导入计划',
    'vis.import.importing': '导入中...',
    'vis.import.sqlPlanHint': '导入 SQL 语句及其 EXPLAIN 输出。格式："gaussdb=# explain select...; PLAN ..."',
    'vis.import.sqlPlanPlaceholder': '在此粘贴 SQL 语句及其执行计划。每个 SQL 后面应跟随其 EXPLAIN 输出...',
    'vis.view': '视图',
