...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // SQL Rewrite
    'rewrite.title': 'SQL Rewrite',
    'rewrite.description': 'Apply automatic SQL rewrite rules (SELECT * expansion, subquery-to-join, etc.)',
    'rewrite.inputLabel': 'SQL Input',
    'rewrite.inputPlaceholder': 'Paste SQL here...',
    'rewrite.button': 'Rewrite SQL',
    'rewrite.loading': 'Rewriting...',
    'rewrite.result': 'Rewrite Result',
    'rewrite.noChange': 'No changes applied — SQL is already optimal',
    'rewrite.changed': 'SQL was rewritten',
    'rewrite.suggestions': 'Suggestions',
    'rewrite.noSuggestions': 'No suggestions',
    'rewrite.matchFailures': 'Rule Match Results',
    'rewrite.schemaLabel': 'Schema JSON (optional)',
    'rewrite.schemaPlaceholder': '{"table_name": {"column": "type"}}',
    'rewrite.original': 'Original SQL',
    'rewrite.rewritten': 'Rewritten SQL',
    'rewrite.copyRewritten': 'Copy Rewritten SQL',
    'rewrite.copied': 'Copied!',
    'rewrite.rules': 'Available Rules',
    'rewrite.confidence': 'Confidence',
    'rewrite.safetyLevel': 'Safety',
  },
  zh: {
    // Menu
    'menu.dashboard': '仪表盘',
    ...
    // SQL Rewrite
    'rewrite.title': 'SQL 改写',
    'rewrite.description': '应用自动 SQL 改写规则（SELECT * 展开、子查询转连接等）',
    'rewrite.inputLabel': 'SQL 输入',
    'rewrite.inputPlaceholder': '在此粘贴 SQL...',
    'rewrite.button': '改写 SQL',
    'rewrite.loading': '改写中...',
    'rewrite.result': '改写结果',
    'rewrite.noChange': '无变更 — SQL 已是最优',
    'rewrite.changed': 'SQL 已改写',
    'rewrite.suggestions': '建议',
    'rewrite.noSuggestions': '无建议',
    'rewrite.matchFailures': '规则匹配结果',
    'rewrite.schemaLabel': 'Schema JSON（可选）',
    'rewrite.schemaPlaceholder': '{"表名": {"列名": "类型"}}',
    'rewrite.original': '原始 SQL',
    'rewrite.rewritten': '改写后 SQL',
    'rewrite.copyRewritten': '复制改写 SQL',
    'rewrite.copied': '已复制！',
    'rewrite.rules': '可用规则',
    'rewrite.confidence': '置信度',
    'rewrite.safetyLevel': '安全级别',
  }
};
